...
export default function MyListingsPage() {
    ...
    const totalRentalVolume = listings.reduce((sum, l) => sum + (l.totalRentals * l.pricePerDay), 0);
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                    {[
                        ...
                        { label: 'Est. Rental Volume', value: `₹${totalRentalVolume.toLocaleString()}`, icon: BarChart3, color: 'text-primary-500' },
